...
Explore a versioned `game.json` that can be interpreted by SpriteKit for selected game classes while preserving Phaser web projects.

## Constraints

- The model emits declarative data and assets, never Swift.
- Schema validation and resource limits precede interpretation.
- Phaser web projects remain supported, exportable, and playable.
